...
@Component({
  selector: 'app-freelancer-onboarding-profile',
  templateUrl: './freelancer-onboarding-profile.component.html',
  styleUrls: ['./freelancer-onboarding-profile.component.scss']
})
export class FreelancerOnboardingProfileComponent implements OnInit {
  @Input() id: any;
  freelancerId: any;
  ...
  constructor(
    ...
    private freelancerMappingService: FreelancerMappingService, private dialog: MatDialog) { }
